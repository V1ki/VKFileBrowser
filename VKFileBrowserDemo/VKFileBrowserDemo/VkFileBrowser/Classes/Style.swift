...
class Style {
    ...
    func parseColor(input: String) -> CGColor? {
        ...
        return UIColor(red: CGFloat((rgbValue & 0xFF0000) >> 16) / 255.0, green: CGFloat((rgbValue & 0x00FF00) >> 8) / 255.0, blue: CGFloat(rgbValue & 0x0000FF) / 255.0, alpha: 1.0).cgColor
    }
    ...
    func addLineNumColor() {
        ...
        var color = UIColor(red: 0, green: 0, blue: 0, alpha: 1.0).cgColor
